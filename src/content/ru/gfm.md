...
> [!NOTE]
> Это содержимое примечания, note alert.

> [!TIP]
> Это содержимое подсказки.

> [!IMPORTANT]
> Это важное содержимое.
> Маркеры в нижнем регистре тоже распознаются. **Жирный**


> [!WARNING]
> Это содержимое предупреждения.

> [!CAUTION]
> Это содержимое предостережения.
