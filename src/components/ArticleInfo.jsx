...
const ArticleInfo = ({ title, cover, date, tags = [], categories = [] , wordCount = 0}) => {
useEffect(() => {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 transition-colors duration-300">
      {/* 背景图片 */}
        ...
        >
          <defs>
            <linearGradient id="lightWave1" x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              <stop offset="50%" stopColor="rgba(226, 232, 240, 0.9)" />
            ...
            <linearGradient id="lightWave2" x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              <stop offset="100%" stopColor="rgba(203, 213, 225, 0.6)" />
            </linearGradient>
          </defs>
        ...
        >
          <defs>
            <linearGradient id="darkWave1" x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              <stop offset="50%" stopColor="rgba(15, 23, 42, 0.4)" />
