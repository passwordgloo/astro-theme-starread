  ...
  return (
    <div className="p-5">
      ...
      <div className="mt-6 text-center text-xs text-gray-500 dark:text-slate-400">
        <a href="https://www.algolia.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
          搜索由
